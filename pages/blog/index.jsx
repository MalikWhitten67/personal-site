          ...
          <div className="flex flex-col gap-5 xl:px-64 lg:px-64 md:px-64 p-5">
            ...
            <ul className="list-disc list-inside">
              ...
              <li>
                <Link
                  key="warm_welcome"
                  href="/blog/general/lw0qsaxnrogkfbg?state=A warm welcome from me!"
              ...
              <li>
                <Link
                  key="vader_blogs"
                  href="/blog/vader_blogs/yosinnfweatoqjw?state=A Day of Struggles and Triumphs: Server-Side Generation with VaderJS"
                  title="Blog"
                  className="text-blue-500 cursor-pointer   hover:underline"
                >
                  A Day of Struggles and Triumphs - 1/25/2024
                </Link>
              </li>
            </ul>
          </div>
